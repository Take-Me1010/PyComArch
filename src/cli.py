...
def parse() -> Args:
    ...
    parser.add_argument("--include-patterns", nargs="*", help="a list of patterns to include files or directories even if it matches exclude_patterns. You can use any rule supported by re module.")
    parser.add_argument("--exclude-patterns", nargs="*", help="a list of patterns to ignore files or directories. You can use any rule supported by re module.")
